...
### [jupyterlab\_spellchecker](https://github.com/ijmbarr/jupyterlab_spellchecker) ⭐ 211 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-09
...
This is a [monorepo](https://github.com/lerna/lerna#what-does-a-lerna-repo-look-like) ⭐ 36,055 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-10 that consists of generic renderers for common file types and mime types as well as renderer extensions for [JupyterLab](https://github.com/jupyterlab/jupyterlab) ⭐ 15,293 | 🐛 2,617 | 🌐 TypeScript | 📅 2026-09-09.
...
### [jupyter-widgets / ipywidgets](https://github.com/jupyter-widgets/ipywidgets) ⭐ 3,329 | 🐛 803 | 🌐 TypeScript | 📅 2026-08-19

ipywidgets are [interactive HTML widgets](https://github.com/jupyter-widgets/ipywidgets/blob/master/docs/source/examples/Index.ipynb) ⭐ 3,329 | 🐛 803 | 🌐 TypeScript | 📅 2026-08-19 for Jupyter notebooks and the IPython kernel. Notebooks come alive when interactive widgets are used. Users gain control of their data and can visualize changes in the data.
...
Seamless integration of [Knowledge-Repo](https://github.com/airbnb/knowledge-repo) ⭐ 5,538 | 🐛 137 | 🌐 Python | 📅 2024-09-04 and [JupyterLab](https://github.com/jupyterlab/jupyterlab) ⭐ 15,293 | 🐛 2,617 | 🌐 TypeScript | 📅 2026-09-09. The Knowledge Repo project is focused on facilitating the sharing of knowledge between data scientists and other technical roles using data formats and tools that make sense in these professions.
...
### [mwouts / jupytext](https://github.com/mwouts/jupytext) ⭐ 7,243 | 🐛 169 | 🌐 Python | 📅 2026-09-09

Jupyter notebooks as Markdown documents, Julia, Python or R scripts.

### [jupyterlab\_email](https://github.com/timkpaine/jupyterlab_email) ⭐ 61 | 🐛 2 | 🌐 Python | 📅 2026-09-06
...
Monorepo to experiment with the top bar space in JupyterLab. Similar to the [status bar](https://github.com/jupyterlab/jupyterlab/tree/master/packages/statusbar-extension) ⭐ 15,293 | 🐛 2,617 | 🌐 TypeScript | 📅 2026-09-09, the top bar can be used to place a few indicators and optimize the overall space.
...
### [jupyterlab\_commands](https://github.com/timkpaine/jupyterlab_commands) ⭐ 63 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-06
