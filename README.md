...
*generated with [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,466 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-04*
...
This is a [monorepo](https://github.com/lerna/lerna#what-does-a-lerna-repo-look-like) ⭐ 36,055 | 🐛 297 | 🌐 TypeScript | 📅 2026-09-26 that consists of generic renderers for common file types and mime types as well as renderer extensions for [JupyterLab](https://github.com/jupyterlab/jupyterlab) ⭐ 15,320 | 🐛 2,604 | 🌐 TypeScript | 📅 2026-09-25.
...
### [mwouts / jupytext](https://github.com/mwouts/jupytext) ⭐ 7,253 | 🐛 166 | 🌐 Python | 📅 2026-09-22
...
Monorepo to experiment with the top bar space in JupyterLab. Similar to the [status bar](https://github.com/jupyterlab/jupyterlab/tree/master/packages/statusbar-extension) ⭐ 15,320 | 🐛 2,604 | 🌐 TypeScript | 📅 2026-09-25, the top bar can be used to place a few indicators and optimize the overall space.
