...
This is a [monorepo](https://github.com/lerna/lerna#what-does-a-lerna-repo-look-like) ⭐ 36,055 | 🐛 297 | 🌐 TypeScript | 📅 2026-09-23 that consists of generic renderers for common file types and mime types as well as renderer extensions for [JupyterLab](https://github.com/jupyterlab/jupyterlab) ⭐ 15,316 | 🐛 2,598 | 🌐 TypeScript | 📅 2026-09-23.
...
### [mwouts / jupytext](https://github.com/mwouts/jupytext) ⭐ 7,252 | 🐛 166 | 🌐 Python | 📅 2026-09-22
...
Monorepo to experiment with the top bar space in JupyterLab. Similar to the [status bar](https://github.com/jupyterlab/jupyterlab/tree/master/packages/statusbar-extension) ⭐ 15,316 | 🐛 2,598 | 🌐 TypeScript | 📅 2026-09-23, the top bar can be used to place a few indicators and optimize the overall space.
