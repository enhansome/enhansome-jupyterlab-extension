...
This is a [monorepo](https://github.com/lerna/lerna#what-does-a-lerna-repo-look-like) ⭐ 36,054 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-19 that consists of generic renderers for common file types and mime types as well as renderer extensions for [JupyterLab](https://github.com/jupyterlab/jupyterlab) ⭐ 15,305 | 🐛 2,599 | 🌐 TypeScript | 📅 2026-09-16.
...
Monorepo to experiment with the top bar space in JupyterLab. Similar to the [status bar](https://github.com/jupyterlab/jupyterlab/tree/master/packages/statusbar-extension) ⭐ 15,305 | 🐛 2,599 | 🌐 TypeScript | 📅 2026-09-16, the top bar can be used to place a few indicators and optimize the overall space.
